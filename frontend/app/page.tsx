  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-4 overflow-hidden">
        ...
        {/* Background gradient */}
        <div className="absolute inset-0 bg-[linear-gradient(135deg,#1e1b4b_0%,#0a0a0a_50%,#1a0a2e_100%)]" />

        {/* Animated orb */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#7c3aed]/10 blur-3xl pointer-events-none" style={{ animation: 'float 8s ease-in-out infinite' }} />
        <div className="absolute top-1/3 left-1/4 w-48 h-48 rounded-full bg-[#4c1d95]/20 blur-2xl pointer-events-none" style={{ animation: 'float 12s ease-in-out infinite reverse' }} />
